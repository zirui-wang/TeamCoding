...
IMAGE_NAME = "ziruiwang/teamcoding_executor"
...
def build_and_run(code, lang):
  ...
  source_file_host_dir = "%s/%s" % (TEMP_BUILD_DIR, source_file_parent_dir_name) # Mac environment
  source_file_guest_dir = "/test/%s" % (source_file_parent_dir_name) # docker container environment
